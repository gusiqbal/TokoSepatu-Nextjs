  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        <button onClick={close} className="absolute top-4 right-4 text-gray-500 hover:text-gray-700" aria-label="close">
          ✕
        </button>
        ...
        <p className="text-sm text-center text-gray-600">
          ...
          <button onClick={switchMode} className="text-red-500 hover:underline font-medium">Sign Up</button>
        </p>
      </div>
    </div>
  );
