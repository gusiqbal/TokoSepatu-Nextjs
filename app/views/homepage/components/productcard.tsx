  ...
  <div className="group">
    ...
    <div className="text-center md:text-left">
      ...
      <div className="flex items-center justify-center md:justify-start gap-2">
        <span className={clsx(product.hasDiscount() ? "text-red-500 border-red-500 border rounded-md px-1 bg-[rgb(255, 245, 246)]" : "text-gray-800", "font-bold flex items-center gap-1")}>{ product.hasDiscount() && <TicketPercent size={20}/>} Rp. { product.priceAfterDiscount }</span>
        {product.hasDiscount() && (
